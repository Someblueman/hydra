...
| Native JSON and terminal rendering | Inspected input/depth limits, string validation, plan duplicate-member checking and terminal control-byte filtering. No additional confirmed finding. |
