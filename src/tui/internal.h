...
enum tone { TONE_BASE, TONE_BORDER, TONE_TITLE, TONE_SELECTED, TONE_WARNING, TONE_STRONG, TONE_SUCCESS, TONE_MUTED, TONE_FOCUS };
...
void style(struct app *app, enum tone tone);
...
void frame_invalidate(struct app *app);
