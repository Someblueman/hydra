...
int main(void) {
    ...
    json_object *graph = f_parse("{\"left\":{\"needs\":\"-\"},\"right\":{\"needs\":\"-\"},\"inspect\":{\"needs\":\"left,right\"},\"compose\":{\"needs\":\"left,right,inspect\"}}");
    json_object *observed = f_parse("{\"states\":{\"compose\":\"queued\",\"inspect\":\"queued\",\"right\":\"ready\",\"left\":\"ready\"},\"cancelled\":false,\"observed_at\":100,\"deadline\":0}");
    ...
    f_string_add(states, "left", "succeeded"); f_string_add(states, "inspect", "ready"); chosen(graph, observed, 2, "");
    f_string_add(states, "right", "succeeded"); chosen(graph, observed, 2, "inspect");
